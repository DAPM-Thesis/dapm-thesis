...
public abstract class OperatorNode<T extends DataType> extends Node implements Subscriber<model.Message<T>> {
    ...
    public model.Topic getOutputTopic() { return outputHandle.getTopic(); }
